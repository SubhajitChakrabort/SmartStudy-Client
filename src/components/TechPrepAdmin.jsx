...
const TechPrepAdmin = () => {
  ...
  const fetchSkills = async () => {
    try {
      ...
      const response = await fetch('http://localhost:5000/api/tech-prep/skills', {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchTopics = async (skillId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`http://localhost:5000/api/tech-prep/skills/${skillId}/topics`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchContent = async (topicId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`http://localhost:5000/api/tech-prep/topics/${topicId}/content`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchStats = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('http://localhost:5000/api/tech-prep/admin/stats', {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleCreateSkill = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('http://localhost:5000/api/tech-prep/admin/skills', {
        method: 'POST',
        headers: {
  ...
  const handleUpdateSkill = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`http://localhost:5000/api/tech-prep/admin/skills/${editingItem.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  const handleDeleteSkill = async (skillId) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`http://localhost:5000/api/tech-prep/admin/skills/${skillId}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleCreateTopic = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('http://localhost:5000/api/tech-prep/admin/topics', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  const handleUpdateTopic = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`http://localhost:5000/api/tech-prep/admin/topics/${editingItem.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  const handleDeleteTopic = async (topicId) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`http://localhost:5000/api/tech-prep/admin/topics/${topicId}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleUploadContent = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5000/api/tech-prep/admin/content', {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleDeleteContent = async (contentId) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`http://localhost:5000/api/tech-prep/admin/content/${contentId}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${token}`,
        },
          ...
          <div className="dropdown">
            ...
            >
              {profileData?.photoUrl ? (
                <img
                  src={`http://localhost:5000${profileData.photoUrl}`}
                  alt="Profile"
